...
public class Time extends BaseTest {
	...
	public void TC01_Time_CreateTimesheet(Map<Object, Object> map) throws IOException {
		...
		String employeeId = pimPage.createEmployee((String) map.get("EmployeeFirstName"),
				(String) map.get("EmployeeMiddleName"), (String) map.get("EmployeeLastName"));
		map.put("EmployeeId", employeeId);

		dashboardPage.clickPIM();

		String employeeFullName = (String) map.get("EmployeeFirstName") + " " + (String) map.get("EmployeeMiddleName")
		...
		// create a timesheet
		String[] workHours = { (String) map.get("MonHours"), (String) map.get("TueHours"), (String) map.get("WedHours"),
				(String) map.get("ThrsHours"), (String) map.get("FriHours") };
